...
app.get('/character/:id/items', User.secure, routes.items);
...
app.post('/character/:id/history/:historyname/delete', User.secure, Character.deleteHistory, routes.histories);
